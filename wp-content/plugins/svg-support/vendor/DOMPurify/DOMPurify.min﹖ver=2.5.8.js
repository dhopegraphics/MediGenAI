...
!(function (e, t) {
  ...
  var ee = (function t() {
        ...
        (mt && mt === t) ||
          ...
          (ge = ge =
            -1 === st.indexOf(t.PARSER_MEDIA_TYPE)
              ? "text/html"
              : t.PARSER_MEDIA_TYPE),
          (ye = "application/xhtml+xml" === ge ? N : v),
          (xe = "ALLOWED_TAGS" in t ? k({}, t.ALLOWED_TAGS, ye) : Oe),
          (ke = "ALLOWED_ATTR" in t ? k({}, t.ALLOWED_ATTR, ye) : Le),
          (ct =
            "ALLOWED_NAMESPACES" in t ? k({}, t.ALLOWED_NAMESPACES, N) : ut),
          (tt =
            "ADD_URI_SAFE_ATTR" in t ? k(L(nt), t.ADD_URI_SAFE_ATTR, ye) : nt),
          (Qe =
            "ADD_DATA_URI_TAGS" in t ? k(L(et), t.ADD_DATA_URI_TAGS, ye) : et),
          (Ze = "FORBID_CONTENTS" in t ? k({}, t.FORBID_CONTENTS, ye) : Je),
          (De = "FORBID_TAGS" in t ? k({}, t.FORBID_TAGS, ye) : {}),
          (Re = "FORBID_ATTR" in t ? k({}, t.FORBID_ATTR, ye) : {}),
          ...
          (He = t.SAFE_FOR_TEMPLATES || !1),
          (ze = !1 !== t.SAFE_FOR_XML),
          (Pe = t.WHOLE_DOCUMENT || !1),
          (Ge = t.RETURN_DOM || !1),
          (We = t.RETURN_DOM_FRAGMENT || !1),
          (qe = t.RETURN_TRUSTED_TYPE || !1),
          (je = t.FORCE_BODY || !1),
          ($e = !1 !== t.SANITIZE_DOM),
          (Ye = t.SANITIZE_NAMED_PROPS || !1),
          (Ke = !1 !== t.KEEP_CONTENT),
          (Ve = t.IN_PLACE || !1),
          (we = t.ALLOWED_URI_REGEXP || we),
          (it = t.NAMESPACE || at),
          (Ce = t.CUSTOM_ELEMENT_HANDLING || {}),
          t.CUSTOM_ELEMENT_HANDLING &&
            pt(t.CUSTOM_ELEMENT_HANDLING.tagNameCheck) &&
            (Ce.tagNameCheck = t.CUSTOM_ELEMENT_HANDLING.tagNameCheck),
          t.CUSTOM_ELEMENT_HANDLING &&
          ...
          Xe &&
            ((xe = k({}, r(H))),
            (ke = []),
            !0 === Xe.html && (k(xe, D), k(ke, z)),
            !0 === Xe.svg && (k(xe, R), k(ke, P), k(ke, j)),
            !0 === Xe.svgFilters && (k(xe, M), k(ke, P), k(ke, j)),
            !0 === Xe.mathMl && (k(xe, F), k(ke, B), k(ke, j))),
          t.ADD_TAGS && (xe === Oe && (xe = L(xe)), k(xe, t.ADD_TAGS, ye)),
          t.ADD_ATTR && (ke === Le && (ke = L(ke)), k(ke, t.ADD_ATTR, ye)),
          t.ADD_URI_SAFE_ATTR && k(tt, t.ADD_URI_SAFE_ATTR, ye),
          t.FORBID_CONTENTS &&
            (Ze === Je && (Ze = L(Ze)), k(Ze, t.FORBID_CONTENTS, ye)),
          Ke && (xe["#text"] = !0),
          Pe && k(xe, ["html", "head", "body"]),
          xe.table && (k(xe, ["tbody"]), delete De.tbody),
          s && s(t),
          (mt = t));
      },
    ...
    var vt = function (e) {
      ...
      Nt = function (e, t) {
        try {
          T(o.removed, { attribute: t.getAttributeNode(e), from: t });
        } catch (e) {
          T(o.removed, { attribute: null, from: t });
        }
      ...
      xt = function (e) {
        ...
        var n = ye(e.nodeName);
        if (
          (wt("uponSanitizeElement", e, { tagName: n, allowedTags: xe }),
          e.hasChildNodes() &&
        ...
        return e instanceof m &&
          ...
          ? (He &&
              ...
              (t = A(t, ve, " ")),
              e.textContent !== t &&
                (T(o.removed, { element: e.cloneNode() }),
                (e.textContent = t))),
      ...
      Ot = function (e, t, n) {
        if ($e && ("id" === t || "name" === t) && (n in i || n in ft))
          return !1;
        if (Ie && !Re[t] && w(Ne, t));
        else if (Me && w(Ee, t));
        else if (!ke[t] || Re[t]) {
              ...
              if (Ue || !w(/\/>/i, r)) {
                ...
                if (Ot(f, a, r))
                  if (
                    (!Ye ||
                      ("id" !== a && "name" !== a) ||
                      (Nt(s, t), (r = "user-content-" + r)),
                    ze && w(/((--!?|])>)|<\/(style|title)/i, r))
                  )
                    Nt(s, t);
                  else {
                    if (
                    ...
                    try {
                      m ? t.setAttributeNS(m, s, r) : t.setAttribute(s, r),
                        St(t) ? vt(t) : b(o.removed);
                    } catch (e) {}
                  }
              } else Nt(s, t);
          }
    ...
    return (
      (o.sanitize = function (t) {
        ...
        if (
          ((lt = !t) && (t = "\x3c!--\x3e"), "string" != typeof t && !_t(t))
        ) {
        ...
        if (
          (Be || dt(f), (o.removed = []), "string" == typeof t && (Ve = !1), Ve)
        ) {
          if (t.nodeName) {
            var p = ye(t.nodeName);
            if (!xe[p] || De[p])
          ...
          (1 ===
            (i = (r = Et("\x3c!----\x3e")).ownerDocument.importNode(t, !0))
              .nodeType &&
            "BODY" === i.nodeName) ||
          "HTML" === i.nodeName
            ? (r = i)
          ...
          if (!Ge && !He && !Pe && -1 === t.indexOf("<"))
            return ie && qe ? ie.createHTML(t) : t;
          if (!(r = Et(t))) return Ge ? null : qe ? le : "";
        }
        r && je && vt(r.firstChild);
        for (var d = At(Ve ? t : r); (c = d.nextNode()); )
          (3 === c.nodeType && c === s) ||
            (xt(c), Lt(c), c.content instanceof l && Ct(c.content), (s = c));
        if (((s = null), Ve)) return t;
        if (Ge) {
          if (We)
            for (m = me.call(r.ownerDocument); r.firstChild; )
              m.appendChild(r.firstChild);
          else m = r;
          return (
            (ke.shadowroot || ke.shadowrootmod) && (m = pe.call(a, m, !0)), m
          );
        }
        ...
        return (
          Pe &&
            ...
            w(Z, r.ownerDocument.doctype.name) &&
            (h = "<!DOCTYPE " + r.ownerDocument.doctype.name + ">\n" + h),
          He && ((h = A(h, be, " ")), (h = A(h, Te, " ")), (h = A(h, ve, " "))),
