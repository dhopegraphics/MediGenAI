jQuery(document).ready(function ($) {
  function t(t) {
    ...
    if (
      ("true" === ForceInlineSVGActive || s || n) &&
      (!svgSettings.skipNested || s || r || !n)
    ) {
      var a = t.attr("id"),
        o = t.attr("class"),
        c = t.attr("src");
      c.endsWith("svg") &&
        $.get(
          ...
          function (i) {
            ...
            void 0 === a
              ? void 0 === r
                ? ((a = "svg-replaced-" + e), (s = s.attr("id", a)))
                : (a = r)
              : (s = s.attr("id", a)),
              void 0 !== o &&
                (s = s.attr("class", o + " replaced-svg svg-replaced-" + e)),
              (s = s.removeAttr("xmlns:a")),
              "on" === frontSanitizationEnabled &&
                "" != s[0].outerHTML &&
                (s = DOMPurify.sanitize(s[0].outerHTML)),
              t.replaceWith(s),
              e++,
              $(document).trigger("svg.loaded", [a]);
          },
          "xml"
        ).fail(function () {});
    }
